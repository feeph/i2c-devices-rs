...
pub enum DR {
    ...
    LutTemp1 = 0x50,  // lookup table temperature #1
    LutStep1 = 0x51,  // lookup table speed step #1
    LutTemp2 = 0x52,  // lookup table temperature #2
    LutStep2 = 0x53,  // lookup table speed step #2
    LutTemp3 = 0x54,  // lookup table temperature #3
    LutStep3 = 0x55,  // lookup table speed step #3
    LutTemp4 = 0x56,  // lookup table temperature #4
    LutStep4 = 0x57,  // lookup table speed step #4
    LutTemp5 = 0x58,  // lookup table temperature #5
    LutStep5 = 0x59,  // lookup table speed step #5
    LutTemp6 = 0x5A,  // lookup table temperature #6
    LutStep6 = 0x5B,  // lookup table speed step #6
    LutTemp7 = 0x5C,  // lookup table temperature #7
    LutStep7 = 0x5D,  // lookup table speed step #7
    LutTemp8 = 0x5E,  // lookup table temperature #8
    LutStep8 = 0x5F,  // lookup table speed step #8
